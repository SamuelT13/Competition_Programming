...
int main() {
	...
	cout << "LCS: " << T.substr(SA[ans.second], ans.first) << " (length " << ans.first << ")\n";
	...
	cout << "LRS of " << T << ": " << T.substr(SA[ans.second], ans.first) << " (length " << ans.first << ")\n";
	
	for (int i = 0; i < n; i++) cout << SA[i] << " " << LCP[i] << " " <<  T.substr(SA[i], T.length()) << "\n"; 
